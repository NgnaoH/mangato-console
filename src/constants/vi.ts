...
export const LANGUAGES_DETECT = [
  { value: LanguagesDetectFormat.eng, label: "Tiếng Anh" },
  { value: LanguagesDetectFormat.jpn, label: "Nhật Bản" },
  { value: LanguagesDetectFormat.vie, label: "Việt Nam" },
  { value: LanguagesDetectFormat.chi_sim, label: "Trung Quốc giản thể" },
];
...
export const USER_ROLE = [
  { value: "user", label: "Người dùng" },
  { value: "uploader", label: "Người đăng tải" },
  { value: "admin", label: "Người quản lí" },
];
