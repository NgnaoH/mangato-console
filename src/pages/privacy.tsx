...
const privacy = () => {
  return (
    <Section className="space-y-8 pt-20">
      ...
      <h1 className="text-2xl font-bold">Interpretation and Definitions</h1>
      ...
      <h1 className="text-2xl font-bold">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="text-2xl font-bold">Changes to this Privacy Policy</h1>
      <p>
      ...
      <ul className="px-4 list-inside list-disc">
        <li>
          <p>By email: hggaming07@gmail.com</p>
        </li>
        <li>
          <p>
